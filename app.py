...
st.write("This app uses machine learning for predicting house price with given features of the house. For using this app you can enter the inputs this UI and then use predict botton.")
...
numberofschools = st.number_input("Number of schools nearby", min_value = 0, value = 3)
